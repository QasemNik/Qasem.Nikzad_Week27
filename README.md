...
## Styles:
**tailwindcss**:
 امکان وارد کردن استایل های بطور مستقیم در کدها که باعث سرعت - عدم تداخل بین استایل های کامپوننت ها و کاهش فایل سی اس اس
**postcss** :
پلاگین هایی برای بهینه کردن فایل سی اس اس
:پلاگین هایی برای بهینه شدن پروژه مثل 
autoprefix - cssnano
...
-- را فراهم می‌کنند که موجب بهبود عملکرد، کاهش تعداد درخواست‌ها به سرور، و بهینه‌سازی کلی تجربه کاربری در پروژه می‌شود.
